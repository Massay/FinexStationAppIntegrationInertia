    ...
    public function getFields($data, $priceStructure, $actualPrice)
    {
        ...
        $formData = [
            ...
            [
                ...
                // 'ago_account_id' => $agoAccountId,
                // 'pms_account_id' => $pmsAccountId,
                'ago_account_id' => $generatorTotalAccountId,
                'pms_account_id' => $generatorTotalAccountId,
            ...
            [
                ...
                // 'ago_account_id' => $agoAccountId,
                // 'pms_account_id' => $pmsAccountId,
                'ago_account_id' => $vehiclesTotalAccountId,
                'pms_account_id' => $vehiclesTotalAccountId,
